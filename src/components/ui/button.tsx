...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-gentle focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-gradient-primary text-primary-foreground hover:shadow-medium",
        destructive:
        ...
        gold: "bg-gradient-gold text-accent-foreground hover:shadow-gold font-semibold",
        hero: "bg-gradient-hero text-primary-foreground hover:shadow-large font-semibold text-base",
        success: "bg-success text-success-foreground hover:bg-success/90",
        worship: "bg-primary-light text-primary-foreground hover:bg-primary-dark transition-gentle",
      },
      size: {
